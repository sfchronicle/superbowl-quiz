...
new Share(".share-button", {
  description: "How big a fan of the NFL are you? Here are 15 questions to test your knowledge of Super Bowl history.",
    ui: {
    flyout: "top center"
  },
  networks: {
    email: {
      description: "How big a fan of the NFL are you? Here are 15 questions to test your knowledge of Super Bowl history." + window.location
    }
  }
});
...
var showQuestion = function(questionId) {
  ...
  if (questionId != 3 && questionId != 4 && questionId != 13) {
...
$(".quiz-container").on("click", ".submit", function() {
  ...
  track("interactive", "superbowl-quiz", (correct ? "correct-" : "wrong-") + id);
  ...
  for (var index in resultsData) {
    ...
    new Share(".share-results", {
      description: "I scored " + result.score + "/" + result.total + "! How big a fan of the NFL are you? Here are 15 questions to test your knowledge of Super Bowl history.",
        ...
        networks: {
          email: {
            description: "I scored " + result.score + "/" + result.total + "! How big a fan of the NFL are you? Here are 15 questions to test your knowledge of Super Bowl history." + window.location
          }
        }
      }
    );
